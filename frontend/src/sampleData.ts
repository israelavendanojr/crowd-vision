export const sampleData: ExtendedCrowdData[] = [
  {
    ...
    frame_summary: "### Comprehensive Safety Analysis and Recommendations\n\n#### Regulatory Compliance Analysis\n\nThe situation violates several safety guidelines and regulations:\n\n1. **Crowd Density**: Zones 0_1, 1_2, and 2_0 significantly exceed recommended crowd density thresholds (Section 9.13, The Event Safety Guide). For example, Zone 0_1 has a crowd density of 176.47 people/m\u00b2, far exceeding safe limits.\n2. **Pit Area Management**: The high-density zones near the stage (e.g., Zone 1_2) indicate potential non-compliance with guidelines for pit area management (Section 9.13.1, The Event Safety Guide), which requires experienced and disciplined security and medical teams.\n3. **Observation Points**: The lack of clear observation points and strategic placement to maximize the view of the audience may violate Section 8.4.9.1 of The Event Safety Guide.\n4. **Production Infrastructure and Backstage Requirements**: The analysis does not provide specific information on backstage areas, but ensuring separate areas for performers and production staff is crucial (Section 8.4.10.1, The Event Safety Guide).\n\n#### Risk Threshold Comparison to Safety Standards\n\n1. **High-Risk Zones**: Zones 0_0, 0_1, 0_2, 1_1, 1_2, 2_0, and 2_2 exceed recommended crowd density thresholds, posing a high risk of crowd-related incidents.\n2. **Moderate-Risk Zones**: Zones 1_3, 2_1, 2_3, 3_1, and 3_2 have moderate crowd densities, approaching critical thresholds, and require careful management.\n\n#### Risk Classification by Severity and Immediacy\n\n1. **High Severity and Immediacy**: Zones with extremely high crowd densities (e.g., Zone 0_1, 1_2, 2_0) require immediate intervention to prevent crowd crush and other safety incidents.\n2. **Moderate Severity and Immediacy**: Zones with moderate crowd densities (e.g., Zone 1_3, 2_3, 3_1) require proactive management to prevent overcrowding and directional conflicts.\n\n#### Detailed Intervention Recommendations\n\n1. **Crowd Management Personnel**: Deploy additional trained crowd management personnel to high-risk zones.\n2. **Signage and Directional Guidance**: Implement clear signage and directional guidance in all zones to manage crowd flow and prevent bottlenecks.\n3. **Emergency Response Planning**: Develop and communicate emergency response plans for all zones, ensuring clear emergency access routes and egress paths.\n4. **Regular Monitoring**: Continuously monitor crowd density and distribution in all zones using surveillance and real-time data analysis.\n\n#### Emergency Response Protocol Requirements\n\n1. **Emergency Response Plan**: Develop a comprehensive emergency response plan, including evacuation procedures, first aid, and communication protocols.\n2. **Trained Personnel**: Ensure that all emergency response personnel are trained and equipped to respond to crowd-related incidents.\n3. **Communication**: Establish clear communication channels between emergency response teams, crowd management personnel, and event organizers.\n\n#### Preventive Measures and Monitoring Protocols\n\n1. **Capacity Planning**: Review and adjust capacity planning to prevent overcrowding.\n2. **Steward Training**: Provide regular training to stewards on crowd management and emergency response procedures.\n3. **Real-Time Monitoring**: Continuously monitor crowd density and distribution using surveillance and real-time data analysis.\n\n#### Technical Safety Calculations\n\n1. **Crowd Density Calculations**: Calculate crowd density in all zones to identify areas exceeding recommended thresholds.\n2. **Risk Assessment**: Conduct regular risk assessments to identify potential safety hazards and implement mitigation measures.\n\n#### Operational Decision Priorities with Implementation Timelines\n\n1. **Short-term (Immediate)**: Implement crowd management strategies, enhance surveillance, and review emergency response plans (within minutes to hours).\n2. **Medium-term (Within Hours to Days)**: Adjust capacity planning, provide training to stewards, and implement crowd control measures.\n3. **Long-term (Pre-Future Events)**: Review and revise overall event planning and capacity management strategies to prevent overcrowding.\n\nBy implementing these recommendations, the risk of crowd-related incidents can be significantly reduced, ensuring a safer environment for all attendees.\n\n### Actionable Analysis for Incident Commanders and Emergency Teams\n\n1. **Immediate Action**: Deploy additional crowd management personnel to high-risk zones and enhance surveillance.\n2. **Short-term Action**: Review and adjust emergency response plans, and implement crowd control measures.\n3. **Continuous Monitoring**: Continuously monitor crowd density and distribution in all zones using surveillance and real-time data analysis.\n\nBy following these guidelines and recommendations, incident commanders and emergency teams can effectively manage the crowd situation and prevent potential safety incidents.",
  },
  {
    ...
    frame_summary: "### Comprehensive Assessment of Crowd Situation Against Safety Guidelines\n\n#### 1. Regulatory Compliance Analysis with Specific Violations\n\nThe situation analysis indicates several potential non-compliances with safety guidelines:\n\n- **Inadequate Briefing and Training**: The text suggests a lack of comprehensive briefing and familiarization among event staff, stewards, and security personnel regarding their roles, responsibilities, and the chain of command. (Guideline 893)\n- **Insufficient Stewarding Provision**: There's an implication that the stewarding provision might not be adequately assessed or adjusted for the specific demands of a music event, such as stewarding the front-of-stage pit. (Guideline 894)\n- **Inadequate 'House Keeping'**: The analysis hints at potential issues with managing the buildup of rubbish and pressure on facilities like toilets during long-duration events. (Guideline 895)\n- **Crowd Density Management**: The text emphasizes the importance of managing crowd density but does not directly state compliance with the guideline of using 0.5 m^2 of available floor space per person for outdoor music events. (Guideline 87)\n\n#### 2. Risk Threshold Comparison to Safety Standards\n\nThe risk associated with the crowd situation appears to be elevated due to potential issues with crowd density management, inadequate stewarding, and insufficient 'house keeping'. These factors could lead to safety hazards that exceed acceptable risk thresholds.\n\n#### 3. Risk Classification by Severity and Immediacy\n\n- **High Severity and Immediacy**: Risks associated with inadequate crowd density management and insufficient stewarding provision are classified as high due to their potential to cause immediate harm.\n- **Moderate Severity and Immediacy**: Issues related to 'house keeping' and facility management are considered moderate as they can impact the comfort and safety of attendees over time.\n\n#### 4. Detailed Intervention Recommendations with Personnel/Equipment Needs\n\n1. **Enhance Stewarding and Security**: Provide specialized training for stewards, especially for tasks like front-of-stage pit stewarding. Increase the number of stewards and security personnel.\n2. **Improve Crowd Density Management**: Implement a crowd monitoring system to track density in real-time. Adjust the layout or restrict entry as necessary to maintain safe densities.\n3. **Enhance 'House Keeping' and Facilities**: Increase the frequency of rubbish collection and ensure adequate toilet facilities and utilities.\n\n#### 5. Emergency Response Protocol Requirements\n\nDevelop and communicate a clear emergency response plan to all staff, including procedures for crowd control, first aid, and evacuation routes. Ensure that all personnel understand their roles and responsibilities.\n\n#### 6. Preventive Measures and Monitoring Protocols\n\n1. **Pre-Event Planning**: Conduct thorough risk assessments and develop comprehensive safety plans.\n2. **Real-Time Monitoring**: Use surveillance and crowd monitoring systems to track crowd dynamics and adjust management strategies as needed.\n3. **Post-Event Review**: Conduct a debrief to identify lessons learned and areas for improvement.\n\n#### 7. Technical Safety Calculations\n\n1. **Crowd Density Calculation**: Use the guideline of 0.5 m^2 per person to determine the maximum safe capacity for the event area.\n2. **Exit Capacity Calculation**: Ensure that exit routes can accommodate the maximum expected crowd within a safe timeframe.\n\n#### 8. Operational Decision Priorities with Implementation Timelines\n\n1. **Short-term (0-2 hours)**: Implement enhanced crowd management measures and increase surveillance.\n2. **Medium-term (2-24 hours)**: Review and adjust the emergency response plan and ensure adequate facilities and utilities.\n3. **Long-term (beyond 24 hours)**: Continuously monitor crowd dynamics and adjust strategies as needed.\n\nThese recommendations are supported by guidelines from the Health and Safety Executive and other safety standards, emphasizing the importance of comprehensive planning, effective crowd management, and continuous monitoring to ensure a safe event.",
  },
  {
    ...
    frame_summary: "### Comprehensive Safety Analysis Report for All Zones\n\n#### Regulatory Compliance Analysis with Specific Violations\n\nUpon analyzing the given crowd situation against the provided safety guidelines, several potential violations and areas of concern have been identified:\n\n1. **Crowd Density Violations**:\n   - Zones 0_2, 1_0, 1_3, 2_2, 2_3, 3_1, and 3_3 exceed recommended crowd density thresholds, posing significant safety risks.\n   - **Specific Violation**: Non-compliance with guidelines stipulating safe crowd densities to prevent overcrowding and crush conditions.\n\n2. **Inadequate Infrastructure**:\n   - Zones 0_3, 2_2, and 3_2 show potential infrastructure risks due to dense vendor stalls and inadequate toilet facilities.\n   - **Specific Violation**: Non-compliance with guidelines requiring adequate infrastructure and amenities to support crowd safety.\n\n3. **Bottlenecks and Escape Routes**:\n   - Zones 0_1, 1_2, 2_0, 2_2, and 3_2 have potential bottlenecks that could impede crowd flow and escape routes.\n   - **Specific Violation**: Non-compliance with guidelines mandating safe crowd flow and accessible escape routes.\n\n#### Risk Threshold Comparison to Safety Standards\n\nThe crowd densities in several zones exceed the recommended safety standards, indicating a high risk level. Specifically:\n\n- Zones 1_0, 1_3, 2_3, and 3_1 have extremely high crowd densities (81 people/m\u00b2, 87 people/m\u00b2, 817 people/m\u00b2, and 44 people/m\u00b2, respectively), significantly exceeding safe thresholds.\n- Zones 0_2, 2_2, and 3_3 also show high crowd densities (8.2 people/m\u00b2, 4 people/m\u00b2, and 5.21 people/m\u00b2, respectively), indicating potential safety risks.\n\n#### Risk Classification by Severity and Immediacy\n\n1. **High Severity and Immediacy**:\n   - Zones 1_0, 1_3, 2_3, and 3_1 due to extremely high crowd densities.\n   - Immediate intervention required to prevent potential crowd crush and safety incidents.\n\n2. **Moderate Severity and Immediacy**:\n   - Zones 0_2, 2_2, and 3_3 due to high crowd densities and potential for overcrowding.\n   - Zones 0_1, 1_2, 2_0, and 3_2 due to potential bottlenecks and infrastructure risks.\n   - Intervention required within a shorter timeframe to mitigate risks.\n\n#### Detailed Intervention Recommendations with Personnel/Equipment Needs\n\n1. **Short-term (Within Hours)**:\n   - Deploy additional crowd control personnel and barriers in high-density zones (1_0, 1_3, 2_3, 3_1).\n   - Enhance surveillance with CCTV cameras and personnel in zones with potential bottlenecks (0_1, 1_2, 2_0, 2_2, 3_2).\n   - Ensure first aid and emergency services are readily available.\n\n2. **Medium-term (Within Days)**:\n   - Review and adjust site layouts to mitigate bottlenecks and improve crowd flow.\n   - Provide additional amenities (e.g., toilet facilities, water stations) in high-density zones.\n\n3. **Long-term (Event Planning Stage for Future Events)**:\n   - Incorporate crowd density management into event design and planning.\n   - Develop comprehensive crowd management plans, including steward training and coordination with emergency services.\n\n#### Emergency Response Protocol Requirements\n\n1. **Activate Emergency Response Plan**:\n   - Have a clear emergency response plan in place, including evacuation procedures and first aid response.\n   - Ensure all personnel are trained and aware of their roles.\n\n2. **Communication**:\n   - Establish clear communication channels between event organizers, crowd control personnel, and emergency services.\n\n#### Preventive Measures and Monitoring Protocols\n\n1. **Crowd Monitoring**:\n   - Continuously monitor crowd density and behavior using CCTV and personnel.\n   - Use data analytics to predict and mitigate potential crowd safety issues.\n\n2. **Steward Training**:\n   - Train stewards and crowd control personnel on crowd management techniques and emergency response procedures.\n\n#### Technical Safety Calculations\n\n1. **Crowd Density Calculations**:\n   - Use crowd density calculations to identify areas exceeding safe thresholds.\n   - Adjust crowd control measures based on these calculations.\n\n2. **Risk Assessment**:\n   - Conduct regular risk assessments to identify potential safety hazards and implement mitigating measures.\n\n#### Operational Decision Priorities with Implementation Timelines\n\n1. **Immediate (Within Hours)**:\n   - Implement crowd control measures in high-density zones.\n   - Enhance surveillance in zones with potential bottlenecks.\n\n2. **Short-term (Within Days)**:\n   - Adjust site layouts to improve crowd flow.\n   - Provide additional amenities in high-density zones.\n\n3. **Long-term (Event Planning Stage for Future Events)**:\n   - Incorporate crowd density management into event design.\n   - Develop comprehensive crowd management plans.\n\n### Actionable Recommendations for Incident Commanders and Emergency Teams\n\n1. **Monitor Crowd Density**: Continuously monitor crowd density in high-risk zones and adjust crowd control measures as needed.\n2. **Activate Crowd Control Measures**: Implement crowd control measures to prevent overcrowding and ensure safe crowd flow.\n3. **Ensure Emergency Services Availability**: Have first aid and emergency services on standby and ensure clear communication channels.\n4. **Communicate with Event Organizers**: Collaborate with event organizers to adjust event operations as necessary to mitigate safety risks.\n\nBy following these recommendations and maintaining a comprehensive safety analysis, incident commanders and emergency teams can effectively manage risks and ensure a safe environment for event attendees.",
  },
  {
    ...
    frame_summary: "### Comprehensive Safety Analysis and Recommendations\n\n#### 1. Regulatory Compliance Analysis with Specific Violations\n\nThe crowd situation analysis reveals several zones with crowd densities exceeding recommended guidelines. Specifically:\n\n* Zones 0_0, 0_3, 2_3, 3_0, and 3_3 exceed the maximum allowable density, violating safety guidelines (e.g., UK \"Guide to Safety at Sports Grounds\" (2008, Fifth Edition)).\n* Zones 1_1, 2_2, and 3_1 approach or exceed critical density thresholds, indicating potential non-compliance with safety regulations.\n\n#### 2. Risk Threshold Comparison to Safety Standards\n\nComparing the observed crowd densities to established safety standards:\n\n* Zones 0_0, 0_3, 2_3, 3_0, and 3_3 pose a high risk, exceeding recommended density guidelines.\n* Zones 1_1, 2_1, 2_2, 3_1, and 3_2 present a moderate risk, approaching or exceeding critical density thresholds.\n\n#### 3. Risk Classification by Severity and Immediacy\n\nBased on the analysis, the risks are classified as follows:\n\n* **High Severity and Immediacy**: Zones 0_0, 0_3, 2_3, 3_0, and 3_3 require immediate intervention.\n* **Moderate Severity**: Zones 1_1, 2_1, 2_2, 3_1, and 3_2 necessitate crowd control measures and enhanced monitoring.\n\n#### 4. Detailed Intervention Recommendations with Personnel/Equipment Needs\n\n1. **Immediate Intervention (High Severity Zones)**:\n\t* Deploy additional security personnel to control crowd movement and density.\n\t* Utilize crowd management barriers to redirect or restrict crowd flow.\n\t* Ensure adequate medical personnel and emergency response teams are on standby.\n2. **Crowd Control Measures (Moderate Severity Zones)**:\n\t* Enhance monitoring through CCTV and personnel surveillance.\n\t* Implement crowd management strategies, such as phased entry and exit, to manage density.\n\t* Position security personnel at key locations to manage crowd flow.\n\n#### 5. Emergency Response Protocol Requirements\n\n1. **Emergency Response Plan**: Review and update the emergency response plan to address potential risks and ensure effective response.\n2. **Communication**: Establish clear communication channels between security, medical, and event management teams.\n3. **Training**: Ensure that all personnel, including security and medical teams, are trained in crowd management and emergency response procedures.\n\n#### 6. Preventive Measures and Monitoring Protocols\n\n1. **Continuous Monitoring**: Regularly monitor crowd density and movement patterns to identify potential risks.\n2. **Crowd Management Strategies**: Implement strategies to manage crowd density, such as phased entry and exit, and crowd flow redirection.\n3. **Signage and Communication**: Ensure clear signage and communication to attendees regarding crowd management and emergency procedures.\n\n#### 7. Technical Safety Calculations\n\nTo determine the maximum allowable crowd density, calculations should be based on the available space, taking into account factors such as:\n\n1. **Available Space**: Calculate the total available space in each zone.\n2. **Crowd Density**: Determine the maximum allowable crowd density based on safety guidelines (e.g., 2-4 people/m\u00b2).\n\n#### 8. Operational Decision Priorities with Implementation Timelines\n\n1. **Immediate Intervention**: Implement crowd control measures in high severity zones within the next 30 minutes.\n2. **Enhanced Monitoring**: Enhance monitoring in moderate severity zones within the next 60 minutes.\n3. **Review and Update Emergency Response Plan**: Review and update the emergency response plan within the next 2 hours.\n\nBy following these recommendations, incident commanders and emergency teams can mitigate the risk of crowd-related incidents and ensure a safe environment for attendees.\n\n**Supporting Guidelines:**\n\n* UK \"Guide to Safety at Sports Grounds\" (2008, Fifth Edition)\n* The Event Safety Guide (v1.1)\n* South Carolina Code of Laws 52-19-30 (for bungee jumping operations)\n\nThese guidelines provide a framework for assessing and managing crowd safety risks. By referencing these guidelines, incident commanders and emergency teams can ensure compliance with established safety standards and best practices.",
  },
  {
